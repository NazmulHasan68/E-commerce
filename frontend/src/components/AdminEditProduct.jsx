...
// for input all the field
  ...
  return (
    <div className=" fixed w-full h-full top-0 bg-slate-400 bg-opacity-40 bottom-0 left-0 right-0 flex 
        justify-center items-center">
      <div className="bg-slate-50 z-40 p-4 rounded shadow-lg w-full max-w-2xl h-full max-h-[80%]">
       ...
       <form className="grid p-4 gap-2" onSubmit={handleSumite}>
        ...
        <button className="py-1 px-3 bg-red-600 text-white mb-2 hover:bg-red-700">Edit Product</button>
       </form>
      </div>
